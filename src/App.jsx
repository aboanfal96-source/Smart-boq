...
export default function App() {
  ...
  const [form, setForm] = useState({
    projectName:"", projectType:"", area:"", floors:"2",
          ...
          <div className="fu">
            <div className="card icard">
              ...
              <div className="fg">
                ...
                <div className="f"><label className="fl">المساحة (م²) <span className="rq">*</span></label><input className="inp" type="number" placeholder="400" value={form.area} onChange={e=>uf("area",e.target.value)}/></div>
          ...
          <div ref={resultRef} className="fu">
            <div className="card sbar">
              <div className="sinfo"><h2 className="ptitle">{form.projectName}</h2>
                <p className="pmeta">{PROJECT_TYPES.find(t=>t.id===form.projectType)?.icon} {PROJECT_TYPES.find(t=>t.id===form.projectType)?.label} • {form.area} م²{isBld?` • ${form.floors} أدوار`:""}{isRoad&&form.roadLength?` • ${form.roadLength} م.ط`:""} • {form.city}</p>
              </div>
              <div className="srow">
